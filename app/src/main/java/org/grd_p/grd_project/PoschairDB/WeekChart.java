...
public class WeekChart {
    public static final String TABLE_NAME = "weekChart";
    ...
    public WeekChart(String week, int k0, int k1, int k2, int k3, int k4, int k5, int k6, int correct_sitting_time, int correct_pelvis, int left_pelvis) {
        this.week = week;
