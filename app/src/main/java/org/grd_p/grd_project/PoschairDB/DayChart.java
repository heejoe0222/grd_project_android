...
public class DayChart {
    public static final String TABLE_NAME = "dayChart";
    ...
    public static final String TOTAL_SITTING = "total_sitting_time";
    ...
    private int total_sitting_time,correct_sitting_time,correct_pelvis,left_pelvis;

    // Create table SQL query
    public static final String CREATE_TABLE =
            "CREATE TABLE " + TABLE_NAME + "("
                    + DATE + " TEXT PRIMARY KEY,"
                    + TOTAL_SITTING + " INTEGER,"
    ...
    public DayChart(String date, int k0, int k1, int k2, int k3, int k4, int k5, int k6, int total_sitting_time, int correct_sitting_time, int correct_pelvis, int left_pelvis) {
        this.date = date;
        this.k0 = k0;this.k1 = k1;this.k2 = k2;this.k3 = k3;
        this.k4 = k4;this.k5 = k5;this.k6 = k6;
        this.total_sitting_time = total_sitting_time;
    ...
    public int getTotal_sitting_time() {
        return total_sitting_time;
    }

    public void setTotal_sitting_time(int total_sitting_time) {
        this.total_sitting_time = total_sitting_time;
    }
